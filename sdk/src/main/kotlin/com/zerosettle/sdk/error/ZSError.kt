...
sealed class ZeroSettleError : Exception() {
    ...
    data class ProductNotFound(val productId: String) : ZeroSettleError() {
        override val message: String get() = "Product not found: $productId"
    }

    /** The checkout flow failed for a specific reason. */
    data class CheckoutFailed(val reason: CheckoutFailure) : ZeroSettleError() {
    ...
    data class UserIdRequired(val productId: String) : ZeroSettleError() {
        override val message: String
...
@Deprecated("Use ZeroSettleError", ReplaceWith("ZeroSettleError"))
typealias ZSError = ZeroSettleError
