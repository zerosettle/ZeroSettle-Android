package io.zerosettle.justone.legacy
...
/** The pre-rewrite 7-tab debug harness UI, extracted verbatim so MainActivity can mount it
 *  behind USE_JUSTONE_NAV=false. Deleted at the Phase 4 cutover. */
@Composable
fun LegacyDebugRoot() {
    MaterialTheme {
        ZeroSettleTheme {
